...
syn region fishSinglequote matchgroup=fishStringDelimiter start=/'/  skip=/\\\\\|\\'/  end=/'/ 
syn region fishString	   matchgroup=fishStringDelimiter start=/"/  skip=/\\\\\|\\"/  end=/"/  contains=fishSpecial,fishOperator,fishDerefIdentifier,fishDerefOpr,fishSpecialShellVar,fishCommandSub 
